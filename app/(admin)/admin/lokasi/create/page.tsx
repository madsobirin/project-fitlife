  ...
  loading: () => (
    <div className="w-full h-[350px] lg:h-[550px] flex items-center justify-center bg-gray-50 border border-gray-100 rounded-3xl">
      <div className="flex flex-col items-center gap-2">
        ...
        <span className="text-xs text-gray-500 font-medium">Memuat peta satelit HD...</span>
      </div>
    </div>
  ),
});
  ...
  const useCurrentLocation = () => {
    ...
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        ...
        () => {
          setErrors((p) => ({ ...p, general: "Gagal mengambil lokasi dari browser. Pastikan izin lokasi diberikan." }));
        },
        { enableHighAccuracy: true, timeout: 10000, maximumAge: 0 }
      );
    } else {
      setErrors((p) => ({ ...p, general: "Fitur lokasi tidak didukung oleh browser Anda." }));
    }
  };
          ...
          <div className="lg:col-span-5 bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-sm space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <span className="text-[10px] text-gray-400 font-medium mb-1 block">Latitude</span>
                  <input
                    value={formLat}
                ...
                <div>
                  <span className="text-[10px] text-gray-400 font-medium mb-1 block">Longitude</span>
                  <input
                    value={formLng}
